...
case "$BUILD_TARGET" in
  "AOSP" ) BUILD_DEFCONFIG=c1_sc02c_aosp_defconfig ;;
  "SAM" ) BUILD_DEFCONFIG=c1_sc02c_samsung_defconfig ;;
...
# *.ko replace
find $OBJ_DIR -name '*.ko' -exec cp -av {} $INITRAMFS_TMP_DIR/lib/modules/ \;
